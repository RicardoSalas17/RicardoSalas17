...
- Integraciones típicas: **pagos (Stripe)**, **media (Cloudinary)**, **tiempo real (WebSockets/Socket.IO)**, **OpenAI API**
...
- **RTSE:** plataforma para perfil médico y consultas (IA) sobre medicamentos/efectos secundarios  
  https://rightsideeffects.com/
- **Oxprox:** webapp/dashboard para explorar proxy voting/ESG en base pública  
